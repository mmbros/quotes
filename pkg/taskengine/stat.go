...
// NOTE: it doesn't check task exists and todo>0.
...
// NOTE: it doesn't check task exists and doing>0.
...
// pick choose among the tasks list the best to execute next.
...
// NOTE: it doesn't check task exists.
